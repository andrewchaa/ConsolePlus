...
namespace ConsolePlus.Infrastructure
{
    ...
    {
        [FieldOffset(0)]
        private int bKeyDown;
        [FieldOffset(4)]
        private short wRepeatCount;
        [FieldOffset(6)]
        private short wVirtualKeyCode;
        [FieldOffset(8)]
        private short wVirtualScanCode;
        [FieldOffset(10)]
        private char cUnicodeChar;
        [FieldOffset(10)]
        private short wUnicodeChar;
        [FieldOffset(10)]
        private byte bAsciiChar;
        [FieldOffset(12)]
        private int dwControlKeyState;
    ...
    {
        [FieldOffset(0)]
        private Coord dwMousePosition;
        [FieldOffset(4)]
        private int dwButtonState;
        [FieldOffset(8)]
        private int dwControlKeyState;
        [FieldOffset(12)]
        private int dwEventFlags;
    ...
    {
        [FieldOffset(0)]
        private ConsoleInputEventType evType;
        ...
        /// </summary>
        [FieldOffset(4)]
        public ConsoleKeyEventInfo KeyEvent;
        /// <summary>
        /// Mouse event information if this is a mouse event.
        /// </summary>
        [FieldOffset(4)]
        public ConsoleMouseEventInfo MouseEvent;
        /// <summary>
        /// Window buffer size information if this is a window buffer size event.
        /// </summary>
        [FieldOffset(4)]
        public ConsoleWindowBufferSizeEventInfo WindowBufferSizeEvent;
        /// <summary>
        /// Menu event information if this is a menu event.
        /// </summary>
        [FieldOffset(4)]
        public ConsoleMenuEventInfo MenuEvent;
        /// <summary>
        /// Focus event information if this is a focus event.
        /// </summary>
        [FieldOffset(4)]
        public ConsoleFocusEventInfo FocusEvent;
